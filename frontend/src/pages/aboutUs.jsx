  ...
  return (
    <div className='w-full min-h-screen text-gray-800'>
      <div className='w-full bg-gradient-to-r from-pink-200 via-pink-100 to-pink-50 py-16 text-center'>
          ...
          <h1 className='text-4xl font-bold mb-4 text-pink-500'>About GlowCare</h1>
        ...
        <div className='mx-auto max-w-[1000px] py-12 px-6 text-center'>
          ...
          <p className='text-gray-800 text-lg'>Our mission is to make beauty accessible to everyone with affordable, authentic,
            & high-quality products.
          </p>
        </div>

        <div className='mx-auto max-w-[1000px] py-12 px-6'>
          <h2 className='text-2xl text-center font-semibold mb-8 text-pink-400'>Why Choose Us</h2>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div className='bg-[#FFFFF0] p-6 rounded-2xl shadow hover:shadow-lg transition'>
        ...
        <div className='py-16 text-center'>
          ...
          <p className='text-gray-600 mb-6'>Our team is here to help you anytime.</p>

          <button className='bg-pink-500 hover:bg-pink-600 text-white font-bold py-3 px-6 rounded-xl transition'>
            Contact Us
          </button>
        </div>
